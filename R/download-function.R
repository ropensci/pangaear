...
#'
#' This function allows you to download a zip file of data from the Pangaea data repository \url{http://www.pangaea.de}. Grabs data as dataframe from a URI. Expects the response data to be in JSON format
#'
